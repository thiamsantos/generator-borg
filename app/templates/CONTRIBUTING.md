...
## Reporting Issues
Found a problem? Want a new feature? First of all see if your issue or idea has [already been reported](https://github.com/<%= githubUsername %>/<%= moduleName %>/issues).
If don't, just open a [new clear and descriptive issue](https://github.com/<%= githubUsername %>/<%= moduleName %>/issues/new).

## Submitting pull requests
Pull requests are the greatest contributions, so be sure they are focused in scope, and do avoid unrelated commits.

- Fork it!
- Clone your fork: `git clone https://github.com/<your-username>/<%= moduleName %>`
- Navigate to the newly cloned directory: `cd <%= moduleName %>`
...
- Configure the remote for your fork: `git remote add upstream https://github.com/<%= githubUsername %>/<%= moduleName %>.git`
